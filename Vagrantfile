...
#      ansible.playbook = "deploy_dockerlab.yml"
##     ansible.groups = {
...
##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update
    ...
    # Default
    dockerlab.vm.provision "main", type: "ansible" do |ansible|
      ansible.playbook = "deploy_dockerlab_DEV.local.yml"
#     ansible.playbook = "deploy_dockerlab_DEV.local.yml"
#     ansible.playbook = "deploy_dockerlabTestRH7.yml"
      ansible.inventory_path = "vagrant_hosts"
    ...
    # Update
#   dockerlab.vm.provision "update", type: "ansible" do |ansible|
